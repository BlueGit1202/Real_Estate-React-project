...
const SitePlanTab = props => {
  ...
  let resizeMargin = () => {
    ...
    if (screenWidth >= 1280) {
      ...
      document
        .getElementsByClassName("setResizeMargin")[0]
        .setAttribute("style", "margin-left:" + getMargin + "px");
    }
  };
          ...
          <div className="col-md-12 col-lg-6">
            <div className="section-head">
              ...
              <p>
                ...
                Floor plans are artist’s rendering. All dimensions are
                approximate.
              </p>
            </div>
            <div className="row">
              <div className="col-md-4 col-sm-4">
                <ul className="nav plan-tabs" id="myTab" role="tablist">
                  ...
                  <li className="nav-item">
                    <a
                      className={
                        classnames({ active: activeTab === "4" }) + " nav-link"
                      }
                      onClick={() => {
                        toggle("4");
                      }}
                  ...
                  <li className="nav-item">
                    <a
                      className={
                        classnames({ active: activeTab === "5" }) + " nav-link"
                      }
                      onClick={() => {
                        toggle("5");
                      }}
                  ...
                  <li className="nav-item">
                    <a
                      className={
                        classnames({ active: activeTab === "6" }) + " nav-link"
                      }
                      onClick={() => {
                        toggle("6");
                      }}
                  ...
                  <li className="nav-item">
                    <a
                      className={
                        classnames({ active: activeTab === "7" }) + " nav-link"
                      }
                      onClick={() => {
                        toggle("7");
                      }}
                  ...
                  <li className="nav-item">
                    <a
                      className={
                        classnames({ active: activeTab === "8" }) + " nav-link"
                      }
                      onClick={() => {
                        toggle("8");
                      }}
                  ...
                  <li className="nav-item">
                    <a
                      className={
                        classnames({ active: activeTab === "9" }) + " nav-link"
                      }
                      onClick={() => {
                        toggle("9");
                      }}
                  ...
                  <TabPane tabId="1">
                    <div className="plan-contant ">
                      <div className="section-head">
                        ...
                        <h4 className="mb-lg-2 mb-xl-4">
                          2 BHK Type-1 Unit Plan, SBUA = 1125.25 SQ.FT
                        </h4>
                        <p>
                          USP: Reduced energy usage and costs, Reduced water
                          usage through low flow fixtures, Improved indoor air
                          quality through the usage of low.
                        </p>
                      </div>
                      ...
                      <Link to={"#"} className="call-planner">
                        <i className="la la-phone-volume" />0333 5429100
                      </Link>
                    </div>
                  </TabPane>
                  <TabPane tabId="2">
                    <div className="plan-contant ">
                      <div className="section-head">
                        ...
                        <h4 className="mb-lg-2 mb-xl-4">
                          2 BHK Type-1 Unit Plan, SBUA = 1280.87 SQ.FT
                        </h4>
                        <p>
                          USP: Reduced energy usage and costs, Reduced water
                          usage through low flow fixtures, Improved indoor air
                  ...
                  <TabPane tabId="3">
                    <div className="plan-contant ">
                      <div className="section-head">
                        ...
                        <h4 className="mb-lg-2 mb-xl-4">
                          2 BHK Type-1 Unit Plan, SBUA = 1198.36 SQ.FT
                        </h4>
                        <p>
                          USP: Reduced energy usage and costs, Reduced water
                          usage through low flow fixtures, Improved indoor air
                  ...
                  <TabPane tabId="4">
                    <div className="plan-contant ">
                      <div className="section-head">
                        <h2 className="title">31.9 Lac</h2>
                        <h4 className="mb-lg-2 mb-xl-4">
                          3 BHK Type-1 Unit Plan, SBUA = 1425.65 SQ.FT
                        </h4>
                        <p>
                          USP: Reduced energy usage and costs, Reduced water
                          usage through low flow fixtures, Improved indoor air
                  ...
                  <TabPane tabId="5">
                    <div className="plan-contant ">
                      <div className="section-head">
                        ...
                        <h4 className="mb-lg-2 mb-xl-4">
                          4 BHK Type-1 Unit Plan, SBUA = 1590.85 SQ.FT
                        </h4>
                        <p>
                          USP: Reduced energy usage and costs, Reduced water
                          usage through low flow fixtures, Improved indoor air
                  ...
                  <TabPane tabId="6">
                    <div className="plan-contant ">
                      <div className="section-head">
                        <h2 className="title">45.2 Lac</h2>
                        <h4 className="mb-lg-2 mb-xl-4">
                          4 BHK Type-1 Unit Plan, SBUA = 1165.28 SQ.FT
                        </h4>
                        <p>
                          USP: Reduced energy usage and costs, Reduced water
                          usage through low flow fixtures, Improved indoor air
