...
const backgrounBlog = [
  {
    image: bnr1,
    title: "Dive in To The Aquamarine waters of our swanky Swimming pool"
  },
        ...
        <div className="page-content bg-white">
            ...
            <div className="container">
              <div className="section-head text-center">
                ...
                <p>
                  ...
                  appealing social spaces, and cultivate your ideal life. We're
                  the fresh look in this historic district - a vibrant new
                  community for movers and shakers.
                </p>
              </div>
              <div className="row">
                <div className="col-md-4 col-lg-2 col-6 mb-4">
                  <div className="aminite-icon-bx">
                    <i className="flaticon-drama" />
                    <h4 className="title">Activity Room</h4>
                  </div>
                </div>
                <div className="col-md-4 col-lg-2 col-6 mb-4 mt-lg-3 mt-0">
                  <div className="aminite-icon-bx">
                    <i className="flaticon-cinema" />
                    <h4 className="title">mini Theater</h4>
                  </div>
                </div>
                <div className="col-md-4 col-lg-2 col-6 mb-4 mt-lg-5 mt-0">
                  <div className="aminite-icon-bx">
                    <i className="flaticon-stationary-bike" />
                    <h4 className="title">Fitnesh Gym </h4>
                  </div>
                </div>
                <div className="col-md-4 col-lg-2 col-6 mb-4 mt-lg-5 mt-0">
                  <div className="aminite-icon-bx">
                    <i className="flaticon-round-table" />
                    <h4 className="title">Multipurpose Hall</h4>
                  </div>
                </div>
                <div className="col-md-4 col-lg-2 col-6 mb-4 mt-lg-3 mt-0">
                  <div className="aminite-icon-bx">
                    <i className="flaticon-gamepad" />
                    <h4 className="title">Games Room</h4>
                  </div>
                </div>
                <div className="col-md-4 col-lg-2 col-6 mb-4">
                  <div className="aminite-icon-bx">
          ...
          <section>
            {backgrounBlog.map((data, index) =>
              <div
                className="aminite-overlay parallax"
              ...
              >
                <div className="aminite-over-area">
                  <div className="overlay-box">
                    ...
                    <p>
                      Swim in the sparking blue water or simply chill out at the
                      pool side. Take a relaxing dip or a few laps in the
                      swimming pool and let the calming water soothe your body
                      and soul
                    </p>
                  </div>
                </div>
